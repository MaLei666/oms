				...
				columns : [
					...
					},
					{
						...
						formatter : function(value, row, index) {
							...
							var d = '<a class="btn btn-warning btn-xs ' + s_remove_h + '" href="#" title="删除"  mce_href="#" onclick="remove2(\''
								+ row.id
								+ '\')"><i class="fa fa-remove"></i></a> ';
							var f = '<a class="btn btn-success btn-xs ' + s_add_h + '" href="#" title="增加"  mce_href="#" onclick="addD(\''
