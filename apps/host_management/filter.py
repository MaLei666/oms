...
class idcFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = idcInfo
        fields = ['name', 'unit_id', 'dept_id', 'isp','status']
...
class hostFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = hostInfo
        fields = ['in_ip', 'out_ip','system','unit_id', 'dept_id', 'idc_id', 'rack_id',
...
class hostServiceFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['name', 'host_id','unit_id', 'dept_id', 'listen_port','status']
...
class databaseFilter(django_filters.FilterSet):
    ...
    class Meta:
        model = databaseInfo
        fields = ['host_id','unit_id', 'dept_id', 'db_name', 'db_version','status']
...
class databaseDBFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['name', 'db_id','unit_id', 'dept_id', 'use','status']
